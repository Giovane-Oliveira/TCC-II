...
public class Alterarimagemdeperfil extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_alterarimagemdeperfil, container, false);
        ((MainActivity) getActivity()).getSupportActionBar().setTitle("Alterar Imagem de Perfil");

        imageView = root.findViewById(R.id.imageViewStorageUpload);
        button = root.findViewById(R.id.btn_upload_enviar);
