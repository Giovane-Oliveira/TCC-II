...
public class RecyclerView_ListaDiario_Paciente extends RecyclerView.Adapter<RecyclerView_ListaDiario_Paciente.ViewHolder> {
    ...
    public RecyclerView_ListaDiario_Paciente(Context context, List<Anotacao> notas, ClickEmpresa clickEmpresa) {
